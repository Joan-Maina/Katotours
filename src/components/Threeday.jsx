    ...
    <div className="#F5F5FC">
      ...
      <div className="maincontent">
        <div className="whattoexpect">
          ...
          <p>
            Description: Pretium, nunc, adipiscing pellentesque viverra cursus
            at faucibus. Risus pellentesque montes, sit facilisis lorem placerat
            ultricies donec dignissim. Praesent facilisi iaculis gravida purus
            a, at eu risus nam. Lectus non eget pharetra, eu, nibh condimentum.
            Dictumst lobortis nisl nunc, ornare enim morbi pulvinar turpis. Eget
            elit est aliquet nunc diam sollicitudin dis.
          </p>
          <p>
            <b>Accomodation</b> : Lorem ipsum
          </p>
